...
// 수 있으면서, 작아서 들고 다니기 편한 지갑을 만들어야 합니다. 이러한 요건을 만족하는 지갑을 만들기 위해
...
fun main() {
    ...
    var minSquare = Int.MAX_VALUE
    var minWidth = Int.MIN_VALUE
    var minHeight = Int.MIN_VALUE

    fun solution(sizes: Array<IntArray>): Int {
        val inputs = arrayListOf<Int>()
        squares = arrayOfNulls(sizes.size)
        for(i in 0..sizes.size) {
            val size = sizes[i]
             minSquare= min(minSquare,size[0] * size[1])
